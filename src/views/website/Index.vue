...
<template>
    <div>
		...
		<div id="page" class="site boxed-layout"> 
                            ...
                            <div class="partner-slider">
                                ...
                                <div class="single-slider">
                                    <div class="single-client">
                                        <a href="#" target="_blank"><img src="../../frontend_assets/img/client/client-1.png" alt="#"></a>
                                    </div>
                                </div>
                                <!--/ End Single client -->
                                <!-- Single client -->
                                <div class="single-slider">
                                    <div class="single-client">
                                        <a href="#" target="_blank"><img src="../../frontend_assets/img/client/client-2.png" alt="#"></a>
                                    </div>
                                </div>
                                <!--/ End Single client -->
                                <!-- Single client -->
                                <div class="single-slider">
                                    <div class="single-client">
                                        <a href="#" target="_blank"><img src="../../frontend_assets/img/client/client-3.png" alt="#"></a>
                                    </div>
                                </div>
                                <!--/ End Single client -->
                                <!-- Single client -->
                                <div class="single-slider">
                                    <div class="single-client">
                                        <a href="#" target="_blank"><img src="../../frontend_assets/img/client/client-4.png" alt="#"></a>
                                    </div>
                                </div>
                                <!--/ End Single client -->
                                <!-- Single client -->
                                <div class="single-slider">
                                    <div class="single-client">
                                        <a href="#" target="_blank"><img src="../../frontend_assets/img/client/client-5.png" alt="#"></a>
                                    </div>
                                </div>
                                <!--/ End Single client -->
                                <!-- Single client -->
                                <div class="single-slider">
                                    <div class="single-client">
                                        <a href="#" target="_blank"><img src="../../frontend_assets/img/client/client-6.png" alt="#"></a>
                                    </div>
                                </div>
                                <!--/ End Single client -->
                            </div>
            ...
            <!-- Footer -->
            <footer class="footer" style="background-image:url('../../frontend_assets/img/map.png')">
                <!-- Footer Top -->
                                    ...
                                    <div class="logo">
                                        <div class="img-logo">
                                            <a class="logo" href="index.html">
                                                <img class="img-responsive" src="../../frontend_assets/img/logo2.png" alt="logo">
                                            </a>
                                        </div>
                                    </div>
...
<style>
@import url('../../frontend_assets/css/bootstrap.min.css');
@import url('../../frontend_assets/css/cubeportfolio.min.css');
@import url('../../frontend_assets/css/font-awesome.css');
@import url('../../frontend_assets/css/jquery.fancybox.min.css');
@import url('../../frontend_assets/css/magnific-popup.min.css');
@import url('../../frontend_assets/css/owl-carousel.min.css');
@import url('../../frontend_assets/css/slicknav.min.css');

@import url('../../frontend_assets/css/reset.css');
@import url('../../frontend_assets/style.css');
@import url('../../frontend_assets/css/responsive.css');
