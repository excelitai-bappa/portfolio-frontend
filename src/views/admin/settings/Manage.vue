                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-8">
                      ...
                      <div class="form-group row">
                        <label for="fb_link" class="col-sm-2 col-form-label"
                          >Facebook Link</label
                        >
                        <div class="col-sm-10">
                          <input
                    ...
                    <div class="col-sm-4">
                      ...
                      <div
                        v-else
                        class="image-input"
                        :style="`background-image: url(${form.logo})`"
                        @click="chooseImage"
                      >
...
export default {
  ...
  methods: {
    async getSetting() {
      ...
      await axios
        .get("http://127.0.0.1:8000/api/setting/show")
        .then((response) => {
    ...
    updateSetting() {
      ...
      formData.append("fb_link", this.form.fb_link);
      formData.append("twitter_link", this.form.twitter_link);
      formData.append("linekdin_link", this.form.linekdin_link);

      let instance = this;
      axios
        .post(`http://127.0.0.1:8000/api/setting/update/${this.form.id}`, formData, {
        ...
        .then(function () {
          ...
          instance.$router.push("/admin/settings");
        })
        .catch(function (error) {
          console.log(error);
        });
